...
# Answer
lett=[a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t]

# Right diagonal
z1=0
for i in range(0,17):
    for x in range(0,17):
        y1=(lett[i][x]*lett[i+1][x+1]*lett[i+2][x+2]*lett[i+3][x+3])
        if y1>=z1:
            z1=y1
print(z1)
...
for i in range(0,17):
    for x in range(0,17):
        y2=(lett[i][x+3]*lett[i+1][x+2]*lett[i+2][x+1]*lett[i+3][x])
        if y2>=z2:
            z2=y2
print(z2)
...
for i in range(0,17):
    for x in range(0,20):
        y3=(lett[i][x]*lett[i+1][x]*lett[i+2][x]*lett[i+3][x])
        if y3>=z3:
            z3=y3
print(z3)
...
for i in range(0,20):
    for x in range(0,17):
        y4=(lett[i][x]*lett[i][x+1]*lett[i][x+2]*lett[i][x+3])
        if y4>=z4:
            z4=y4
print(z4)

# Final answer
print('The greatest product of four adjacent numbers is ',max(z1,z2,z3,z4))
